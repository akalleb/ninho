  ...
  const fileList = [
    {
      ...
      name: '1.png',
      status: 'done',
      url: getImageUrl('static/img/products/1.png'),
      thumbUrl: getImageUrl('static/img/products/1.png'),
    },
  ];
            ...
            <Cards headless>
              <Row gutter={25} justify="center">
                <Col xxl={12} md={14} sm={18} xs={24}>
                  <AddProductForm>
                    <Form className="w-100" layout="vertical" form={form} name="addProduct" onFinish={handleSubmit}>
                      <BasicFormWrapper>
                                ...
                                <Cards title="About Product">
                                  ...
                                  <Form.Item label="Price">
                                    <Form.Item name="price" noStyle>
                                      <InputNumber
                                        className="w-100"
                                        addonBefore={<FeatherIcon icon="dollar-sign" size={14} />}
                                      />
                                    </Form.Item>
                                  </Form.Item>
                                  ...
                                  <Form.Item label="Discount">
                                    <Form.Item name="discount" noStyle>
                                      <InputNumber
                                        className="w-100"
                                        addonBefore={<FeatherIcon icon="percent" size={14} />}
                                      />
                                    </Form.Item>
                                  </Form.Item>
