...
// SVG paths - Next.js will handle basePath automatically for these paths
// Using relative paths from public directory
const progressSvg = '/static/img/progress.svg';
const progressActiveSvg = '/static/img/progress-active.svg';
...
const SidebarSingle = Styled.div`
    ...
    .ant-checkbox-group.ratings-list{
        display: flex;
        flex-direction: column;
        gap: 0;
...
const ProductCard = Styled.div`
    ...
    .product-single-rating{
        ...
        .ant-rate-star{
            ${({ theme }) => (!theme.rtl ? 'margin-right' : 'margin-left')}: 3px !important;
        }
        .ant-rate-star-full,
        .ant-rate-star-half{
            .ant-rate-star-first,
...
const ProductDetailsWrapper = Styled.div`
    ...
    .product-details-box__right{
        ...
        .ant-rate-star{
            ${({ theme }) => (theme.rtl ? 'margin-left' : 'margin-right')}: 3px !important;
        }
        .ant-rate-star-full,
        .ant-rate-star-half{
            .ant-rate-star-first,
...
const AddProductForm = Styled.div`
        ...
        .ant-form-item{
            ...
            .ant-input-number{
                ...
                .ant-input-number-group-addon{
                    ...
                    border-${({ theme }) => (theme.rtl ? 'left' : 'right')}: 1px solid ${({ theme }) => theme['border-color-light']};
                    border-radius: ${({ theme }) => (theme.rtl ? '0 6px 6px 0' : '6px 0 0 6px')};
                    width: 44px;
                    display: flex;
                    align-items: center;
                    justify-content: center;
                ...
                &.ant-input-number-group-wrapper{
                    .ant-input-number-wrapper{
                        .ant-input-number{
                            border-radius: ${({ theme }) => (theme.rtl ? '6px 0 0 6px' : '0 6px 6px 0')};
                        }
                    }
                }
            }
    ...
    .input-prepend-wrap{
        ...
        .input-prepend{
            ...
            border-radius: ${({ theme }) => (theme.rtl ? '0 6px 6px 0' : '6px 0 0 6px')};
            border: 1px solid ${({ theme }) => theme['border-color-light']};
            border-${({ theme }) => (theme.rtl ? 'left' : 'right')}: none;
            z-index: 10;
            pointer-events: none;
            svg{
                color: ${({ theme }) => theme['gray-color']};
        ...
        .ant-input-number{
            ...
            .ant-input-number-input-wrap{
                ${({ theme }) => (theme.rtl ? 'padding-right' : 'padding-left')}: 44px;
            }
            .ant-input-number-input{
...
const CheckoutWrapper = Styled.div`
    ...
    .ant-steps-item-container{
        ...
        &:after{
            ...
            top: 20px;
            color: #333;
            background-image: url(${progressSvg});
            width: 137%;
            height: 6px;
    ...
    padding: ${({ theme }) => (theme.rtl ? '0 0 0 25px !important' : '0 25px 0 0 !important')} ;
        ...
        &.ant-steps-item-finish{
            .ant-steps-item-container{
                &:after{
                    background-image: url(${progressActiveSvg});
                }
            }
            .ant-steps-item-title{
                color: ${({ theme }) => theme['dark-color']} !important;
