...
import sampleData from '../../demoData/sampleCards.json';
import BannerCard from '../../components/cards/BannerCard';
import FileListCard from '../project/overview/FileListCard';

const { cardOne, cardTwo, cardThree, cardFive, cardSix, cardSeven } = sampleData;

const actions = (
  <>
    <a href="#" className="cursor-pointer d-inline-flex align-items-center mr-8">
    ...
    <a href="#" className="cursor-pointer d-inline-flex align-items-center">
