...
const CalendarWrapper = Styled.div`
    ...
    .ant-picker-calendar-header .ant-picker-super-prev-icon,
    .ant-picker-calendar-header .ant-picker-super-next-icon,
    .ant-picker-calendar-header .ant-picker-prev-icon,
    .ant-picker-calendar-header .ant-picker-next-icon{
        margin-top: -3px;
    }
