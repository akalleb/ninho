            ...
            >
              <h4 className="list-header-title">
                ...
                <Dropdown
                  content={
                    <>
                      <a href="#" onClick={(e) => { e.preventDefault(); onBoardEditable(e); }} className="cursor-pointer">
                        <span>Edit Card Title</span>
                      </a>
                      <a href="#" onClick={(e) => { e.preventDefault(); deleteBoardHandler(board); }} className="cursor-pointer">
                ...
                >
                  <span className="btn-more cursor-pointer d-inline-block">
              ...
              {provided => (
                <>
                  ...
                  <div className={addTaskActive ? 'sDash_addTask-control add-task-on' : 'sDash_addTask-control'}>
                    <span className="btn-addTask cursor-pointer d-flex align-items-center" onClick={(e) => handleActiveAddTask(e)}>
                    ...
                    <div className="sDash_addTask-from">
                      ...
                      <div className="sDash_addTask-action">
                        ...
                        <span onClick={(e) => handleOffAddTask(e)} className="cursor-pointer d-inline-block">
