                  ...
                  return (
                    <li className="sDash_tasks-item" key={i}>
                      ...
                      <div className="sDash_tasks-item__action">
                        <span
                          className={`${item.favourite ? 'task-favourite active' : 'task-favourite'} cursor-pointer d-inline-block`}
                        ...
                        <Dropdown
                          content={
                            <>
                              <a href="#" onClick={(e) => { e.preventDefault(); showModal(item.id, item); }} className="cursor-pointer d-flex align-items-center">
                                <FeatherIcon icon="edit" size={14} />
                                <span>Edit</span>
                              </a>
                              <a href="#" onClick={(e) => { e.preventDefault(); handleTaskDelete(item.id); }} className="cursor-pointer d-flex align-items-center">
