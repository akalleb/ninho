  ...
  const handleSubmit = async (values) => {
    ...
    try {
      const payload = {
        ...
        auto_charge_mode: null,
        auto_charge_flat_amount: null,
        auto_charge_service_type_rates: null,
        auto_charge_professional_rates: null,
        auto_charge_expense_destination: null,
        auto_charge_expense_description: null,
        auto_charge_expense_category_id: null,
      };
