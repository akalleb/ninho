      ...
      <Main>
        <Row gutter={25}>
          <Col md={12} xs={24}>
            <Cards title="Basic">
              <SelectWrapperStyle>
                <Select defaultValue="lucy" className="w-120">
                ...
                <Select defaultValue="lucy" className="w-120" disabled>
                  <Option value="lucy">Lucy</Option>
                </Select>
                <Select defaultValue="lucy" className="w-120" loading>
                  <Option value="lucy">Lucy</Option>
                </Select>
              </SelectWrapperStyle>
            </Cards>
            ...
            <Cards title="Select Size">
              ...
              <div className="tag-select-list">
                <Select size={size} defaultValue="a1" onChange={handleChange} className="w-200">
                  {children}
                </Select>
                <Select
                  mode="multiple"
          ...
          <Col md={12} xs={24}>
            <Cards title="Select Coordinate">
              <SelectWrapperStyle>
                <Select defaultValue={provinceData[0]} className="w-120" onChange={handleProvinceChange}>
                  {provinceData.map((province) => (
                    <Option key={province}>{province}</Option>
                  ))}
                </Select>
                <Select className="w-120" value={state.secondCity} onChange={onSecondCityChange}>
                  {cities.map((city) => (
