        ...
        <Row gutter={25}>
          <Col md={12}>
            ...
            <Cards title="Rounded" size="large">
              ...
              <Button size="default" shape="round" type="secondary">
                Secondary
              </Button>
              <Button size="default" shape="round" type="success">
                Success
              </Button>
              <Button size="default" shape="round" type="info">
                Info
              </Button>
              <Button size="default" shape="round" type="warning">
                Warning
              </Button>
              <Button size="default" shape="round" type="danger">
                Danger
              </Button>
              <Button size="default" shape="round" type="dark">
                Dark
              </Button>
              <Button size="default" shape="round" type="light">
                Light
              </Button>
              <Button size="default" shape="round" type="white">
                White
              </Button>
            </Cards>
          ...
          <Col md={12}>
            ...
            <Cards title="Rounded Outline" size="large">
              ...
              <Button size="default" outlined shape="round" type="secondary">
                Secondary
              </Button>
              <Button size="default" outlined shape="round" type="success">
                Success
              </Button>
              <Button size="default" outlined shape="round" type="info">
                Info
              </Button>
              <Button size="default" outlined shape="round" type="warning">
                Warning
              </Button>
              <Button size="default" outlined shape="round" type="danger">
                Danger
              </Button>
              <Button size="default" outlined shape="round" type="dark">
                Dark
              </Button>
              <Button className="btn-outlined" size="default" outlined shape="round" type="light">
                Light
              </Button>
              <Button size="default" outlined shape="round" type="dashed">
                Dashed
              </Button>
            </Cards>
            ...
            <Cards title="Rounded with Icon" size="large">
              ...
              <Button size="default" shape="round" transparented type="primary">
                <FeatherIcon icon="layers" />
                Default
              </Button>
              <Button size="default" shape="round" outlined type="primary">
                <FeatherIcon icon="layers" />
                Default
              </Button>
              <Button className="btn-outlined" size="default" shape="round" outlined type="light">
                <FeatherIcon icon="layers" />
                Default
              </Button>
              <Button size="default" shape="round" type="light">
              ...
              <Button size="default" shape="round" raised type="white">
                <FeatherIcon icon="layers" />
                Default
              </Button>
              <Button className="btn-icon" size="default" shape="circle" type="primary">
                <FeatherIcon icon="layers" />
              </Button>
              <Button className="btn-icon" size="default" outlined shape="circle" type="primary">
                <FeatherIcon icon="layers" />
              </Button>
              <Button className="btn-icon btn-outlined" size="default" outlined shape="circle" type="light">
                <FeatherIcon icon="layers" />
              </Button>
              <Button className="btn-icon" size="default" shape="circle" type="light">
                <FeatherIcon icon="layers" />
              </Button>
            </Cards>
            ...
            <Cards title="Loading" size="large">
              ...
              <Button size="default" shape="round" outlined type="white">
                <FeatherIcon icon="layers" />
                Default
              </Button>
              <Button size="default" shape="round" type="light">
