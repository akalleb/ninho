        ...
        <Row gutter={25}>
          <Col xs={24}>
            <Cards title="Basic card" size="large">
              <Col lg={8} md={10} xs={24} className="p-0">
                <CardStyleWrapper>
                  <Cards title="Default Size Card" border size="default" moreText more={content} className="w-400">
                    <p>Card content</p>
                    <p>Card content</p>
                    <p>Card content</p>
                    <p>Card content</p>
                  ...
                  <Cards title="Small size card" border size="small" moreText more={content} className="w-400">
                    <p>Card content</p>
                    <p>Card content</p>
                    <p>Card content</p>
                    <p>Card content</p>
            ...
            <Cards title="No border" size="large">
              <Col lg={8} md={10} xs={24} className="p-0 mb-n20">
                <CardStyleWrapper>
                  <Cards
          ...
          <Col xs={24}>
            <div className="card-grid-wrap">
              <Cards title="Grid Card" size="large">
                <Card.Grid className="w-25 text-center p-24">Content</Card.Grid>
                <Card.Grid className="w-25 text-center p-24">Content</Card.Grid>
                <Card.Grid className="w-25 text-center p-24">Content</Card.Grid>
                <Card.Grid className="w-25 text-center p-24">Content</Card.Grid>
                <Card.Grid className="w-25 text-center p-24">Content</Card.Grid>
