        ...
        <Row gutter={25}>
          <Col sm={12} xs={24}>
            ...
            <Cards title="Three Size" caption="The simplest use of Time picker">
              <div className="timepicker-list">
                <TimePicker defaultValue={moment('12:08:23', 'HH:mm:ss')} className="mr-10" />
                <TimePicker
          ...
          <Col sm={12} xs={24}>
            ...
            <Cards title="12 hours" caption="The simplest use of Time picker">
              <div className="timepicker-list">
                <TimePicker use12Hours className="mr-10" />
                <TimePicker use12Hours format="h:mm:ss A" className="mr-10" />
