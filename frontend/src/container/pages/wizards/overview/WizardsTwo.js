...
// Memoized Credit Card Form Component
const CreditCardForm = memo(({ form, month }) => {
  return (
      ...
      <Form layout="vertical" form={form} name="info">
        ...
        <Row gutter={12}>
          <Col span={12}>
            <Form.Item name="month" initialValue="" label="Expiration Date">
              <Select 
                className="w-100" 
                getPopupContainer={() => typeof window !== 'undefined' ? document.body : document.createElement('div')}
              >
          ...
          <Col span={12}>
            <Form.Item name="year" initialValue="" label=" ">
              <Select 
                className="w-100" 
                getPopupContainer={() => typeof window !== 'undefined' ? document.body : document.createElement('div')}
              >
        ...
        <Form.Item name="cvv" label="CVV">
          <div className="cvv-wrap">
            <Input className="w-60" placeholder="XXX" />
      ...
      return dataSource.push({
        ...
        product: (
          <div className="cart-single">
            <FigureWizards>
              <img className="w-80px" src={getImageUrl(img)} alt="" />
              <figcaption>
          ...
          steps={[
            {
              ...
              icon: <ReactSVG src={getImageUrl('static/img/icon/user.svg')} />,
              content: (
            ...
            },
            {
              ...
              className: 'wizard-step-item',
              icon: <ReactSVG src={getImageUrl('static/img/icon/address.svg')} />,
              content: (
                <BasicFormWrapper className="basic-form-inner">
                  <div className="atbd-form-checkout">
                    <Row justify="center">
            ...
            },
            {
              ...
              className: 'wizard-step-item',
              icon: <ReactSVG src={getImageUrl('static/img/icon/155-credit-card.svg')} />,
              content: (
                <BasicFormWrapper className="basic-form-inner">
                  <div className="atbd-form-checkout">
                    <Row justify="center">
                                  ...
                                  >
                                    <div className="supported-card d-flex">
                                      ...
                                      <div className="supported-card_logos">
                                        <img
                                          className="w-50px"
                                          src={getImageUrl('static/img/cards-logo/ms.png')}
                                          alt=""
                                        />
                                        <img
                                          className="w-50px"
                                          src={getImageUrl('static/img/cards-logo/american-express.png')}
                                          alt=""
                                        />
                                        <img
                                          className="w-50px"
                                          src={getImageUrl('static/img/cards-logo/visa.png')}
                                          alt=""
                                        />
                                      </div>
                                    </div>
                                    <CreditCardForm form={form} month={month} />
                                  </Cards>
                                </Radio>
                              </div>
            ...
            },
            {
              title: 'Review Order',
              className: 'wizard-step-item',
              icon: <ReactSVG src={getImageUrl('static/img/icon/024-like.svg')} />,
              content:
                status !== 'finish' ? (
                            ...
                            <Radio.Group className="w-100">
                              <Radio value="ms" style={{ width: '100%' }}>
                                <div className="method-info">
                                  <img src={getImageUrl('static/img/ms.svg')} alt="" />
                                  **** **** **** 2597
                                </div>
                              </Radio>
                            </Radio.Group>
