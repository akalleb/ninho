...
// Pre-compute SVG URLs for use in styled-components
const progressSvgUrl = getImageUrl('static/img/progress.svg');
const progressActiveSvgUrl = getImageUrl('static/img/progress-active.svg');
const progressSuccessSvgUrl = getImageUrl('static/img/progress-success.svg');
...
const WizardWrapper = Styled.div`
    ...
    .ant-steps-item-container{
        ...
        &:after{
            ...
            top: 20px;
            color: #333;
            background-image: url(${progressSvgUrl});
            width: 114%;
            height: 6px;
    ...
    .wizard-steps-item-active{
        .ant-steps-item-container{
            &:after{
                background-image: url(${progressActiveSvgUrl});
            }
        }
    }
    .success-step-item{
        .ant-steps-item-container{
            &:after{
                background-image: url(${progressSuccessSvgUrl});
            }
        }
    }
    .ant-steps-item{
