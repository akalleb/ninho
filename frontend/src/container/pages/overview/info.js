    ...
    <Row justify="center">
      <Col xl={10} md={16} xs={24}>
        <div className="user-info-form">
          <BasicFormWrapper>
            <Form layout="vertical" className="w-100" form={form} name="info" onFinish={handleSubmit}>
              <Heading className="form-title" as="h4">
                Personal Information
              </Heading>

              <figure className="photo-upload align-center-v">
                <img src={getImageUrl('static/img/avatar/profileImage.png')} alt="" />
                <figcaption>
                  <Upload>
              ...
              <Form.Item>
                <div className="add-user-bottom text-right">
                  ...
                  <Button htmlType="submit" type="primary">
                    <NextLink to="/admin/users/add-user/work">Save & Next</NextLink>
                  </Button>
                </div>
              </Form.Item>
            </Form>
