...
// Swiper modules are imported by react-id-swiper automatically
  ...
  const galleryParams = {
    ...
    pagination: {
      ...
      renderBullet(index, className) {
        return `<span class="${className} pagination-thumb"><img src="${getImageUrl(users[index].img)}" alt="" /></span>`;
      },
    },
  };
  const paramsThree = {
                    ...
                    {users.map((user, index) => {
                      return (
                        <div key={index + 1} className="testimonial-block__single">
                          <figure>
                            <img src={getImageUrl(user.img)} alt="" />
                            <figcaption>
                      ...
                      return (
                        <div key={index + 1} className="testimonial-block__single">
                          <span className="quotation">
                            <img src={getImageUrl('static/img/icon/quote.png')} alt="" />
                          </span>
