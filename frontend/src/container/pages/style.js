...
// Pre-compute arrow icon URLs for use in styled-components CSS content
const arrowLeftIconUrl = getImageUrl('static/img/icon/arrow-left.svg');
const arrowRightIconUrl = getImageUrl('static/img/icon/arrow-right.svg');
