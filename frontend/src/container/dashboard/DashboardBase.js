          ...
          <Col xs={24}>
            <DashboardBaseStyleWrap>
              <Cards headless title="Buttons" size="large">
                <Row gutter={15}>
                  <Col md={6}>
                    <Button type="primary" size="small" className="mr-10 mb-10">
                      Small
                    </Button>
                    <Button type="primary" className="mr-10 mb-10">
                      Normal
                    </Button>
                    <Button type="primary" size="large" className="mr-10 mb-10">
                      Large Button
                    </Button>
                    <Button outlined type="primary" size="small" className="mr-10 mb-10">
                      Small
                    </Button>
                    <Button outlined type="primary" className="mr-10 mb-10">
                      Normal
                    </Button>
                    <Button outlined type="primary" size="large" className="mr-10 mb-10">
                      Large Button
                    </Button>
                    <Button type="secondary" size="small" className="mr-10 mb-10">
                      Small
                    </Button>
                    <Button type="secondary" className="mr-10 mb-10">
                      Normal
                    </Button>
