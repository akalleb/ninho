            ...
            <div className="card-nav">
              <ul>
                <li className={state.location === 'today' ? 'active' : 'deactivate'}>
                  <span onClick={() => handleActiveChangeLocation('today')} className="cursor-pointer">
                    Today
                  </span>
                </li>
                <li className={state.location === 'week' ? 'active' : 'deactivate'}>
                  <span onClick={() => handleActiveChangeLocation('week')} className="cursor-pointer">
                    Week
                  </span>
                </li>
                <li className={state.location === 'month' ? 'active' : 'deactivate'}>
                  <span onClick={() => handleActiveChangeLocation('month')} className="cursor-pointer">
                    Month
                  </span>
                </li>
                <li className={state.location === 'year' ? 'active' : 'deactivate'}>
                  <span onClick={() => handleActiveChangeLocation('year')} className="cursor-pointer">
                    Year
                  </span>
                </li>
              </ul>
