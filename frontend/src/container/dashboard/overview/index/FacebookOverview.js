                            ...
                            datasets={[
                              {
                                ...
                                backgroundColor: () =>
                                  chartLinearGradient(document.getElementById('engaged'), 185, {
                                    start: '#20C99710',
                                    end: '#20C99701',
                                  }),
                                pointHoverRadius: 0,
                            ...
                            datasets={[
                              {
                                ...
                                tension: 0.4,
                                backgroundColor: () =>
                                  chartLinearGradient(document.getElementById('impression'), 185, {
                                    start: '#FF69A510',
                                    end: '#FF69A501',
                                  }),
                                pointHoverRadius: 0,
                            ...
                            datasets={[
                              {
                                ...
                                tension: 0.4,
                                backgroundColor: () =>
                                  chartLinearGradient(document.getElementById('likes'), 185, {
                                    start: '#5F63F210',
                                    end: '#5F63F201',
                                  }),
                                pointHoverRadius: 0,
                            ...
                            datasets={[
                              {
                                ...
                                tension: 0.4,
                                backgroundColor: () =>
                                  chartLinearGradient(document.getElementById('impression2'), 185, {
                                    start: '#FA8B0C10',
                                    end: '#FA8B0C01',
                                  }),
                                pointHoverRadius: 0,
