  ...
  return (
    ...
    >
      <div className="project-modal">
        <BasicFormWrapper>
          <Form layout="vertical" form={form} name="createProject" onFinish={handleOk}>
            ...
            <div className="projects-members mb-30">
              <img className="w-35px" src={getImageUrl('static/img/users/1.png')} alt="" />
              <img className="w-35px" src={getImageUrl('static/img/users/2.png')} alt="" />
              <img className="w-35px" src={getImageUrl('static/img/users/3.png')} alt="" />
              <img className="w-35px" src={getImageUrl('static/img/users/4.png')} alt="" />
              <img className="w-35px" src={getImageUrl('static/img/users/5.png')} alt="" />
            </div>
            <Row gutter={15}>
              <Col md={12}>
