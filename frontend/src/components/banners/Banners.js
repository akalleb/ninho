  ...
  return (
    <BannerWrapper>
      <Cards className="mb-70" bodyStyle={{ background: '#5F63F2', borderRadius: '10px', minHeight: '270px' }} headless>
        <Figure2>
          <img src={getImageUrl('static/img/banner/1.png')} alt="" />
          <figcaption>
  ...
  return (
    <BannerWrapper>
      <Cards  bodyStyle={{ borderRadius: '10px', minHeight: '270px', background: '#5F63F2' }} headless>
        <Figure3>
          <img src={getImageUrl('static/img/banner/2.png')} alt="" />
          <figcaption>
    ...
    <BannerWrapper>
      <Cards bodyStyle={{ background: '#272B41', borderRadius: '10px', minHeight: '270px' }} headless>
        <Figure3 className="theme-3">
          <img src={getImageUrl('static/img/banner/3.png')} alt="" />
          <figcaption>
    ...
    <BannerWrapper>
      ...
      >
        <Figure3 className="theme-wide">
          <img src={getImageUrl('static/img/banner/4.png')} alt="" />
          <figcaption>
...
const Banner6 = () => {
  return (
    <BannerWrapper>
      <Cards
        bodyStyle={{
          background: `url(${getImageUrl('static/img/banner/5.png')})`,
      ...
      >
        <Figure6>
          <img src={getImageUrl('static/img/banner/badge.svg')} alt="" />
          <figcaption>
            <h2>Up to 50 OFF</h2>
...
const Banner7 = () => {
  return (
    <BannerNormal className="theme-wide">
      <Cards headless>
        <Figure7>
          <img src={getImageUrl('static/img/banner/6.png')} alt="" />
          <figcaption>
      ...
      <Carousel autoplay>
        <div className="banner-signle">
          <div className="banner-single__img">
            <img src={getImageUrl('static/img/banner/8.png')} alt="" />
          </div>
  ...
  return (
    <BannerLongWrap>
      <div className="banner-long-inner">
        <h2>Up To Date </h2>
        <img src={getImageUrl('static/img/banner/9.png')} alt="" />
      </div>
    </BannerLongWrap>
  );
};
...
const BannerCard = () => {
  return (
    <BannerCardWrap>
      <div className="banner-card-inner" style={{backgroundImage: `url("${getImageUrl('static/img/banner/card-banner-1.png')}")`}}>
...
const BannerCard2 = () => {
  return (
    <BannerCardWrap>
      <div className="banner-card-inner theme-2" style={{backgroundImage: `url("${getImageUrl('static/img/banner/card-banner-2.png')}")`}}>
...
const BannerCta = () => {
  return (
    <BannerCtaWrap>
      <div className="banner-cta align-center-v" style={{backgroundImage: `url("${getImageUrl('static/img/banner/cta-banner-1.png')}")`}}>
...
const BannerCta2 = () => {
  return (
    <BannerCtaWrap>
      <div className="banner-cta align-center-v theme-2" style={{backgroundImage: `url("${getImageUrl('static/img/banner/cta-banner-2.png')}")`}}>
        <div className="banner-cta__content">
