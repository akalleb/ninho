...
function SwRocket({ size = 16, color = '#ADB4D2', stroke = 'none', strokeWidth = 'none' }) {
  return (
...
function SwShieldCheck({ size = 16, color = '#ADB4D2', stroke = 'none', strokeWidth = 'none' }) {
  return (
...
function SwPenTool({ size = 16, color = '#ADB4D2', stroke = 'none', strokeWidth = 'none' }) {
  return (
...
function SwNotification({ size = 16, color = '#ADB4D2', stroke = 'none', strokeWidth = 'none' }) {
  return (
...
function SwUsers({ size = 16, color = '#ADB4D2', stroke = 'none', strokeWidth = 'none' }) {
  return (
    <svg
      id="Group_1013"
...
function SwLayers({ size = 16, color = '#ADB4D2', stroke = 'none', strokeWidth = 'none' }) {
  return (
...
function SwPicture({ size = 16, color = '#ADB4D2', stroke = 'none', strokeWidth = 'none' }) {
  return (
...
function SwClock({ size = 16, color = '#ADB4D2', stroke = 'none', strokeWidth = 'none' }) {
  return (
...
function SwSend({ size = 16, color = '#ADB4D2', stroke = 'none', strokeWidth = 'none' }) {
  return (
...
function SwGraph({ size = 16, color = '#ADB4D2', stroke = 'none', strokeWidth = 'none' }) {
  return (
...
function SwEllipse({ size = 16, color = '#ADB4D2', stroke = 'none', strokeWidth = 'none' }) {
  return (
