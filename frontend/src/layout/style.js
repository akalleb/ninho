            ...
            .ant-menu{
                ...
                .ant-menu-submenu{
                    .ant-menu-submenu-title{
                        display: flex;
                        align-items: center;
                        justify-content: ${({ theme }) => (theme.rtl ? 'flex-start' : 'flex-start')};
                ...
                .ant-menu-item{
                    ...
                    .ant-menu-title-content {
                        margin-inline-start: ${({ theme }) => (theme.rtl ? '0' : '20px')} !important;
                        margin-inline-end: ${({ theme }) => (theme.rtl ? '20px' : '0')} !important;
                        a {
                            padding: 0 !important;
                        }
                    }
                ...
                .ant-menu-item{
                    ...
                    &.ant-menu-item-selected{
                        border-radius: 4px;
                        background-color: ${({ theme, darkMode }) => (darkMode ? 'rgba(255, 255, 255, .05)' : `${theme['primary-color']}10`)};
                        a{
                            color: ${({ theme }) => theme['primary-color']};
                        }
                        svg, i{
        ...
        ul{
            li{
                ...
                &.has-subMenu-left{
                    >a{
                        ...
                        &:before{
                            ...
                            ${({ theme }) => (theme.rtl ? 'left' : 'right')}: 30px;
                            top: 50%;
                            transform: ${({ theme }) => (theme.rtl ? 'translateX(-50%) rotate(180deg)' : 'translateX(-50%)')};
                            font-family: "FontAwesome";
                            content: '\f105';
                            line-height: 1;
                            color: ${({ theme }) => theme['light-color']};
                ...
                a{
                    ...
                    img,
                    i{
                        margin-right: ${({ theme }) => (theme.rtl ? '0' : '14px')};
                        margin-left: ${({ theme }) => (theme.rtl ? '14px' : '0')};
                        width: 16px;
                    }
                }
                >ul{
